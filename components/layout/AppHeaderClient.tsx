...
import { SignInButton, SignUpButton, UserAvatar } from "@clerk/nextjs"; // useUser se quita
...
export default function AppHeaderClient({ isSignedIn }: AppHeaderClientProps) {
        ...
        <nav className="hidden md:flex items-center gap-4">
          {!isSignedIn ? (
            <>
              ...
              <SignUpButton mode="modal" unsafeMetadata={{role: "tower"}} forceRedirectUrl="/dashboard">
